#დავალება: ახსენი ეს კოდი

# elif a == "search": #if search is chosen
#          dict_namesearch = input("which guest do you want to search: ") #asking which guest specifically to search up
#          for key, value in thisdict.items(): #creating key, value pairs
#             if value["name"] == dict_namesearch:
#                 print(key,value)
#             else:
...
#print(thisdict)
    ...
    #This part is for removing a guest from the Dictionary
        ...
        dict_guestreplace = input("which guest do you want to replace: ")
        dict_replaceedit = input("name or age: ")
        if dict_replaceedit == "name":
            del thisdict[dict_guestreplace]["name"]
        elif dict_replaceedit == "age":
            del thisdict[dict_guestreplace]["age"]
        print(thisdict)
# დავალება 15სთვის
    elif a == "value":
        dict_valueremove = input("which guest: ")
        dict_valuechose = input("name or age: ")
        if dict_valuechose == "name":
             thisdict[dict_valueremove]["name"] = " "
        elif dict_valuechose == "age":
             thisdict[dict_valueremove]["age"] = " "
        print(thisdict) 
